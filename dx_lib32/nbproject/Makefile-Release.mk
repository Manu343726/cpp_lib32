...
${OBJECTDIR}/_ext/1028437842/dl32Color.o: ../code/source/dl32Color.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1028437842/dl32Color.o ../code/source/dl32Color.cpp

${OBJECTDIR}/_ext/1028437842/dl32Console.o: ../code/source/dl32Console.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1028437842
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1028437842/dl32Console.o ../code/source/dl32Console.cpp

${OBJECTDIR}/_ext/1028437842/dl32Graphics.o: ../code/source/dl32Graphics.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1028437842
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1028437842/dl32Graphics.o ../code/source/dl32Graphics.cpp

${OBJECTDIR}/_ext/1028437842/dl32Math.o: ../code/source/dl32Math.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1028437842
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1028437842/dl32Math.o ../code/source/dl32Math.cpp

${OBJECTDIR}/_ext/1028437842/dl32String.o: ../code/source/dl32String.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1028437842
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1028437842/dl32String.o ../code/source/dl32String.cpp

${OBJECTDIR}/_ext/1028437842/dl32Window.o: ../code/source/dl32Window.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1028437842
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1028437842/dl32Window.o ../code/source/dl32Window.cpp

${OBJECTDIR}/_ext/1133222896/dl32Memory.o: ../code/source/utils/dl32Memory.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1133222896
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1133222896/dl32Memory.o ../code/source/utils/dl32Memory.cpp

${OBJECTDIR}/_ext/1133222896/dl32Timing.o: ../code/source/utils/dl32Timing.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1133222896
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1133222896/dl32Timing.o ../code/source/utils/dl32Timing.cpp

${OBJECTDIR}/_ext/1133222896/dl32Utils3D.o: ../code/source/utils/dl32Utils3D.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1133222896
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1133222896/dl32Utils3D.o ../code/source/utils/dl32Utils3D.cpp
...
${OBJECTDIR}/_ext/461600824/EcuationSolverTest.o: ../code/tests/general\ tests/EcuationSolverTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/461600824/EcuationSolverTest.o ../code/tests/general\ tests/EcuationSolverTest.cpp

${OBJECTDIR}/_ext/461600824/GeneralStressTest.o: ../code/tests/general\ tests/GeneralStressTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/461600824
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/461600824/GeneralStressTest.o ../code/tests/general\ tests/GeneralStressTest.cpp

${OBJECTDIR}/_ext/461600824/MatrixTest.o: ../code/tests/general\ tests/MatrixTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/461600824
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/461600824/MatrixTest.o ../code/tests/general\ tests/MatrixTest.cpp
...
${OBJECTDIR}/_ext/92388514/IsometricEngine.o: ../code/tests/isometric\ tilemap/IsometricEngine.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/92388514/IsometricEngine.o ../code/tests/isometric\ tilemap/IsometricEngine.cpp

${OBJECTDIR}/_ext/92388514/IsometricEngineTest.o: ../code/tests/isometric\ tilemap/IsometricEngineTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/92388514
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/92388514/IsometricEngineTest.o ../code/tests/isometric\ tilemap/IsometricEngineTest.cpp

${OBJECTDIR}/_ext/1950470279/MandelbrotEngine.o: ../code/tests/mandlebrot/MandelbrotEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1950470279
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1950470279/MandelbrotEngine.o ../code/tests/mandlebrot/MandelbrotEngine.cpp

${OBJECTDIR}/_ext/1950470279/MandelbrotFractalTest.o: ../code/tests/mandlebrot/MandelbrotFractalTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1950470279
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1950470279/MandelbrotFractalTest.o ../code/tests/mandlebrot/MandelbrotFractalTest.cpp
...
${OBJECTDIR}/_ext/695214021/Particle_engine.o: ../code/tests/particle\ engine/Particle\ engine.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/695214021/Particle_engine.o ../code/tests/particle\ engine/Particle\ engine.cpp

${OBJECTDIR}/_ext/695214021/ParticleEngineTest.o: ../code/tests/particle\ engine/ParticleEngineTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/695214021
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/695214021/ParticleEngineTest.o ../code/tests/particle\ engine/ParticleEngineTest.cpp

${OBJECTDIR}/_ext/809142145/PolylineTest.o: ../code/tests/polyline/PolylineTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/809142145
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/809142145/PolylineTest.o ../code/tests/polyline/PolylineTest.cpp

${OBJECTDIR}/_ext/227780153/Pong.o: ../code/tests/pong/Pong.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/227780153
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/227780153/Pong.o ../code/tests/pong/Pong.cpp
