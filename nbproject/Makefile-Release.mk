...
${OBJECTDIR}/code/source/utils/dl32Utils3D.o: code/source/utils/dl32Utils3D.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/code/source/utils/dl32Utils3D.o code/source/utils/dl32Utils3D.cpp
...
${OBJECTDIR}/code/source/dl32String.o: code/source/dl32String.cpp 
	${MKDIR} -p ${OBJECTDIR}/code/source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/code/source/dl32String.o code/source/dl32String.cpp
...
${OBJECTDIR}/code/source/dl32Graphics.o: code/source/dl32Graphics.cpp 
	${MKDIR} -p ${OBJECTDIR}/code/source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/code/source/dl32Graphics.o code/source/dl32Graphics.cpp
...
${OBJECTDIR}/code/source/dl32Console.o: code/source/dl32Console.cpp 
	${MKDIR} -p ${OBJECTDIR}/code/source
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/code/source/dl32Console.o code/source/dl32Console.cpp
