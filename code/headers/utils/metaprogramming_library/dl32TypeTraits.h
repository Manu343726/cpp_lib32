...
/// @author	Manu343726
///
/// @remarks Speciallization for function pointers.
///////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename RETURN_TYPE , typename... ARGS>
class dl32IsClass<RETURN_TYPE(ARGS...)>
{
public:
    static const bool value = false;
};
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Makes a const reference type of the original type.
///
/// @author	Manu343726
///////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename T>
struct dl32MakeConstReference : public dl32TypeWrapper<const T&> {};
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Makes a const reference type of the original type if a boolean condition is true. If its false,
///        makes the same type.
///
/// @author	Manu343726
///////////////////////////////////////////////////////////////////////////////////////////////////////
template<bool CONDITION , typename T>
using dl32MakeConstReferenceIf = typename dl32SelectType<CONDITION,typename dl32MakeConst<T>::type,T>::type;
