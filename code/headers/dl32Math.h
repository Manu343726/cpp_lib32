...
struct dl32Vector2D:public dl32Point2D
{
	...
	static float Angle(const dl32Vector2D &V1, const dl32Vector2D &V2){return acos(Mul(V1,V2)*DL32FLOAT_INVSQRT(V1.x*V1.x+V1.y*V1.y)*DL32FLOAT_INVSQRT(V2.x*V2.x+V2.y*V2.y));}//Una peque�a optimizaci�n...
...
protected:
	...
	float a,b,c;//Ax + By + C = 0 (Ecuaci�n general)
public:
	dl32Line2D();
