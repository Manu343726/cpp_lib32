...
#define DL32DEBUG_DL32CONSOLE_AUTOOPEN ANDOP(\
									   OROP(DL32DEBUG_DL32WINDOW_PROMPTUNHANDLEDWMSGS,DL32DEBUG_DL32WINDOW_PROMPTPREPROCESSEDWMSGS),\
									   ENABLED) //Abre la consola automáticamente si se hace una escritura con la consola cerrada (Solo para depuración)
...
#define DL32DEBUG_GRAPHICS_PROMPTTIMING NO
